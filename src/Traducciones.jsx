...
import flagItaliano from "./assets/imagenes/flag-italian.png";
import flagPortugal from "./assets/imagenes/flag-portugal.png";
import flagFrance from "./assets/imagenes/flag-france.png";
...
const Traducciones = () => {
  ...
  return (
    <>
  <div className="traducciones-box-body">
  ...
  <main className="traducciones-main-portafolio">
          ...
          <section className="traducciones-list-card">
            <h1>Willkommen in die welt der kultur und der Sprachen</h1>
            <div className="traducciones-list-boxcard">
              <section className="traducciones-list-product">
                <div className="traducciones-card-animation">
                  <img src={flagAlemania} alt="Alemania" />
                  <div className="traducciones-card-emergent">
                    <p>
                ...
                <div className="traducciones-card-body">
                  <h3 className="traducciones-title-img-portafolio">ALEMAN</h3>
                </div>
              </section>
              <section className="traducciones-list-product">
                <div className="traducciones-card-animation">
                  <img src={flagEEUU} alt="EEUU" />
                  <div className="traducciones-card-emergent">
                    <p>
                      Tecnoduck es una plataforma de distribución de coronavirus de última generación. Las compañías usan esta plataforma para el espionaje digital y los ataques a los servidores seguros de la competencia.
                    </p>
                ...
                <div className="traducciones-card-body">
                  <h3 className="traducciones-title-img-portafolio">INGLES</h3>
                </div>
              </section>
              <section className="traducciones-list-product">
                <div className="traducciones-card-animation">
                  <img src={flagItaliano} alt="Italiano" />
                  <div className="traducciones-card-emergent">
                    <p>
                      Tecnoduck es una plataforma de distribución de coronavirus de última generación. Las compañías usan esta plataforma para el espionaje digital y los ataques a los servidores seguros de la competencia.
                    </p>
                ...
                <div className="traducciones-card-body">
                  <h3 className="traducciones-title-img-portafolio">ITALIANO</h3>
                </div>
              </section>
              <section className="traducciones-list-product">
                <div className="traducciones-card-animation">
                ...
                <div className="traducciones-card-body">
                  <h3 className="traducciones-title-img-portafolio">PORTUGUES</h3>
                </div>
              </section>
              <section className="traducciones-list-product">
                <div className="traducciones-card-animation">
                  <img src={flagFrance} alt="Frances" />
                  <div className="traducciones-card-emergent">
                    <p>
                      Tecnoduck es una plataforma de distribución de coronavirus de última generación. Las compañías usan esta plataforma para el espionaje digital y los ataques a los servidores seguros de la competencia.
                    </p>
                ...
                <div className="traducciones-card-body">
                  <h3 className="traducciones-title-img-portafolio">FRANCES</h3>
                </div>
              </section>
            </div>
          {/* Botón de contactar y modal (idéntico a Clases.jsx) - debajo de las tarjetas */}
          <div className="traducciones-contact-section">
            <button onClick={() => document.getElementById('modal3').style.display = 'block'}>Contactar</button>
            {/* Modal de contacto */}
            <div id="modal3" className="traducciones-modal3" style={{display: 'none'}}>
              <div className="traducciones-modal-content">
                <span className="traducciones-cerrar" onClick={() => document.getElementById('modal3').style.display = 'none'}>&times;</span>
                <h2>Contáctanos</h2>
                <form id="formContacto" onSubmit={e => {
                  e.preventDefault();
                  document.getElementById('mensajeExito').textContent = '¡Mensaje enviado!';
                  setTimeout(() => {
                ...
                <p id="mensajeExito" className="traducciones-exito"></p>
              </div>
            </div>
          </div>
          </section>

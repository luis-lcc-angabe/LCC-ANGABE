...
import abcdAleman from "./assets/imagenes/abcd-aleman.png";
...
const Clases = () => {
          ...
          <div className="container">
            <nav className="header-nav">
              ...
              <ul className="header-menu" id="header-menu">
                ...
                <li><Link className="link-header barra" to="/clases">Clases</Link></li>
  ...
  <main className="clases-main-portafolio">
          ...
          <section className="clases-list-card">
            <h1>Willkommen in die welt der kultur und der Sprachen</h1>
            <div className="clases-list-boxcard">
              <section className="clases-list-product">
                <div className="clases-card-animation">
                  <img src={abcdAleman} alt="" />
                  <div className="clases-card-emergent">
                    <p>
                      Con los cursos podrás aprender alemán de manera fácil, ya seas principiante, sepas un poco o mucho, aquí mejorarás tu vocabulario y pronunciación, desde el nivel A1 hasta C1, con excelentes profesores y material didáctico.
                    </p>
                  </div>
                </div>
                <div className="clases-card-body">
                  <h3 className="clases-title-img-portafolio">ALEMAN</h3>
                </div>
              </section>
              <div className="clases-contact-section">
                <button onClick={() => document.getElementById('modal3').style.display = 'block'}>Contactar</button>
                {/* Modal de contacto */}
                <div id="modal3" className="clases-modal3" style={{display: 'none'}}>
                  <div className="clases-modal-content">
                    <span className="clases-cerrar" onClick={() => document.getElementById('modal3').style.display = 'none'}>&times;</span>
                    <h2>Contáctanos</h2>
                    ...
                    <p id="mensajeExito" className="clases-exito"></p>
                  </div>
                </div>
              </div>
            </div>

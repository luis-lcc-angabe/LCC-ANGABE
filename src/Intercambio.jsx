...
import imgAlemania from "./assets/imagenes/Intercambio en Alemania.png";
import imgAustria from "./assets/imagenes/Intercambio en austria.png";
import imgLuxemburgo from "./assets/imagenes/Intercambio en Luxemburgo.png";
import imgSuiza from "./assets/imagenes/Intercambio en Suiza.png";
import imgLiechtenstein from "./assets/imagenes/Intercambio liechtenstein.png";
import "./css/moderno-normalizar.css";
import "./css/styles.css";
import "./css/intercambio.css";
...
const Intercambio = () => {
          ...
          <div className="container">
            <nav className="header-nav">
              ...
              <ul className="header-menu" id="header-menu">
                ...
                <li><Link className="link-header barra" to="/intercambio">Intercambio</Link></li>
  ...
  <main className="intercambio-main-portafolio">
          ...
          <section className="intercambio-list-card">
            <h1>Willkommen in die welt der kultur und der Sprachen</h1>
            <section className="intercambio-carousel">
              <img src={imgAlemania} className="active" alt="Alemania" />
              <img src={imgAustria} alt="Austria" />
              <img src={imgLuxemburgo} alt="Luxemburgo" />
              <img src={imgSuiza} alt="Suiza" />
              <img src={imgLiechtenstein} alt="Liechtenstein" />
            </section>
            <div className="intercambio-contact-section">
              <button onClick={() => document.getElementById('modal3').style.display = 'block'}>Contactar</button>
              {/* Modal de contacto */}
              <div id="modal3" className="intercambio-modal3" style={{display: 'none'}}>
                <div className="intercambio-modal-content">
                  <span className="intercambio-cerrar" onClick={() => document.getElementById('modal3').style.display = 'none'}>&times;</span>
                  <h2>Contáctanos</h2>
                  ...
                  <p id="mensajeExito" className="intercambio-exito"></p>
                </div>
              </div>
            </div>
          </section>

...
const Cotizacion = () => {
  ...
  // Funcionalidad JS del formulario de cotización
        ...
        <main className="main-portafolio">
          <div className="box-cont">
            <div className="content">
              <h2>COTIZACION</h2>
              <form id="formCotizacion" onSubmit={enviarFormulario}>
                ...
                <button type="submit" className="submit-btn">Enviar Solicitud De Cotización</button>
                <p id="mensajeExito" style={{color: 'green', display: 'none', marginTop: 10}}>¡Enviado correctamente!</p>
              </form>
            </div>
          </div>

...
export default function TeamSection() {
  return (
    <section className="team">
      <h2 className="title-team">Nuestro Equipo</h2>
      <ul className="box-imag-team">
        <svg className="stylesvg">
          <defs>
            ...
            <symbol id="linkend" viewBox="0 0 20 20" width="22px" height="22px">
        ...
        <li className="card car-margin">
          ...
          <ul>
            ...
            <li>
              <svg className="icon-card"><use href="#twiter"></use></svg>
            </li>
            <li>
              <svg className="icon-card"><use href="#instagram"></use></svg>
            </li>
            <li>
              <svg className="icon-card"><use href="#linkend"></use></svg>
            </li>
          </ul>
        </li>
        <li className="card">

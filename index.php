        ...
        <div class="container">
            <nav class="header-nav">
                ...
                <ul class="header-menu ">
                    <li class="open_submenu"> <a class="link-header barra " href="./index.html"> Inicio</a></li>
                    <li> <a class="link-header" href="./portafolio.html"> Clases</a></li>
    ...
    <main>
        ...
        <section class="banner">
            ...
            <div class="buttons banner-button">
                <button class="open-modal-btns" onclick="openModal()" type="button">COTIZA AHORA</button>
            </div>
                ...
                <div class="list-boxcard">
                    <section class="list-product">
                        <div class="card-animation">
                            ...
                            <div class="card-emergent">
                                <p>
                                Contamos con cursos en el idioma Aleman, para q aprendas o te refurces en este idioma.
                                </p>
                            </div>
                        </div>
                        <div class="card-body" >
                    ...
                    <section class="list-product">
                        <div class="card-animation">
                            ...
                            <div class="card-emergent">
                                <p>
                                Lcc traducciones tiene asocio con traductores de aleman, ingles, italiano, frances y portugues.
                                </p>
                            </div>
                        </div>
                        <div class="card-body" >
                            <h3 class="title-img-portafolio">Traducciones</h3>
                    ...
                    <section class="list-product">
                        <div class="card-animation">
                            ...
                            <div class="card-emergent">
                                <p>
                                Tenemos asesoria para intercambios universitarios y asesoria de Aupair. En Alemania, Austria, Suiza, Luxemburgo y Liechtenstein.
                                </p>
                            </div>
                        </div>
                        <div class="card-body" >
                            <h3 class="title-img-portafolio">Intercambio Cultural</h3>
                        </div>
                    </section>
                </div>
            </section>
